...
def draw_single_valve(
    ...
    def T(s, x, y, h=0.25, rot=0.0):
        import math as _math
        ent = ms.AddText(str(s), _pt(x, y), float(h))
        if rot:
            try:
                ent.Rotation = _math.radians(float(rot))
            except Exception:
                pass
    ...
    T("CLOSED", 214.58, 109.55, 0.10, 90)
    ...
    T("A2",  217.33, 99.55, 0.10)
    T("A1",  217.33, 100.05, 0.10)
    ...
    T("A2",  218.53, 99.55, 0.10)
    T("A1",  218.53, 100.05, 0.10)
